...
print (colored(0, 255, 127,"║                                                 ║"))                
print (colored(0, 255, 127,"║          Supra Node Latency Tester  V1          ║"))               
print (colored(0, 255, 127,"║                                                 ║"))                
print (colored(0, 255, 127,"║               www.supranodes.com                ║")) 
print (colored(0, 255, 127,"║                                                 ║"))               
print (colored(0, 255, 127,"╚═════════════════════════════════════════════════╝"))                
print ("")
print (colored(0, 191, 255,"Join us on discord.gg/v4YAfwbj7z"))

print ("")
print ("")

print ("Enter the amount of request")
